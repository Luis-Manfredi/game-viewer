...
class HorizontalStackSignup extends StatelessWidget {
  const HorizontalStackSignup({ Key? key }) : super(key: key);
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              child: const Text('Sign up with', style: TextStyle(color: darkIndigo, fontSize: 16)),
                            ),
                            ...
                            children: [
                              Row(
                                children: [
                                  Container(
                                    margin: const EdgeInsets.only(bottom: 5),
                                    child: const Text('Already have an account? ', style: TextStyle(color: darkIndigo, fontSize: 12))
                                  ),
                                  Container(
                                    margin: const EdgeInsets.only(bottom: 5),
                                    child: TextButton(
                                      ...
                                      child: const Text('Sign Up', style: TextStyle(color: darkIndigo, fontSize: 12)),
