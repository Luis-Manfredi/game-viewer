...
class VerticalStackLogin extends StatelessWidget {
  const VerticalStackLogin({
    Key? key,
    required this.size,
  }) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text('Login with', style: TextStyle(color: darkIndigo)),
                  ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: const Text('Sign Up', style: TextStyle(color: darkIndigo)),
